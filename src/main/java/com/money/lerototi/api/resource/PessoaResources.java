...
public class PessoaResources {
	...
	@Autowired
	private ApplicationEventPublisher publisher; //dispara o evento (publicador)
	...
	public ResponseEntity<?> listarPessoas(){
		List<Pessoa> pessoasRetornadas = pessoaRepository.findAll();
		return !pessoasRetornadas.isEmpty() ? ResponseEntity.ok(pessoasRetornadas) : ResponseEntity.noContent().build();
	}
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void alterarPropriedadeAtivo(@PathVariable Long codigo, @RequestBody Boolean ativo, HttpServletResponse response){
